    ...
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div>
          ...
          <input type="text" className="w-full p-2 border rounded" placeholder="例如：草船借箭"
            value={form.theme} onChange={e => setForm(f => ({ ...f, theme: e.target.value }))} />
        </div>
        <div>
          <label className="block text-sm">适龄段</label>
          <select className="w-full p-2 border rounded" value={form.age} onChange={e => setForm(f => ({ ...f, age: e.target.value }))}>
        ...
        <div>
          ...
          <select className="w-full p-2 border rounded" value={form.style} onChange={e => setForm(f => ({ ...f, style: e.target.value }))}>
            <option value="">请选择</option>
        ...
        <div className="col-span-1 sm:col-span-2 lg:col-span-3">
          ...
          <input type="text" className="w-full p-2 border rounded" placeholder="例如：勇敢、智慧、合作"
